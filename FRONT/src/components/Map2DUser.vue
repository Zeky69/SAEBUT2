  ...
  <div class="all-container">
    ...
    <div>
      ...
      <div v-for="(type, index) in types" :key="index">
        <input type="checkbox" :value="type" v-model="filtre.type" :id="'type_' + index" name="type">
      ...
      <div>
        ...
        <input type="text" v-model="filtre.nom" id="nom" name="nom">
      </div>
      </div>
  ...
  watch: {
    'filtre.type': function () {
      ...
      this.filteredFeature = this.features.filter((feature) => {
        const isTypeTerrain = this.filtre.type.length === 0 || this.filtre.type.includes(feature.properties.typeTerrain);
