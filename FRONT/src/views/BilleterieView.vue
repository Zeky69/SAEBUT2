<template>
  <div class="billetterie-container">
    ...
    <div class="body-container">
      ...
      <choice-billet ref="choiceBillet" :items=items @selected="setSelected"></choice-billet>
...
import ChoiceBillet from "@/components/Billet.vue";
import ChoiceDate from "@/components/choiceDate.vue";
import ChoiceQuantity from "@/components/choiceQuantity.vue";
